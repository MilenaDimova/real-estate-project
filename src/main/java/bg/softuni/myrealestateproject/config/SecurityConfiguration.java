...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, SecurityContextRepository securityContextRepository) throws Exception {
        httpSecurity.authorizeHttpRequests()
                ...
                .requestMatchers("/", "/users/signin", "/users/register", "/offers/sales", "/offers/rents", "/contact", "/about-us").permitAll()
                .requestMatchers("/offers/add").hasRole(RoleTypeEnum.USER.name())
                .requestMatchers("/offers/add").hasRole(RoleTypeEnum.ADMIN.name())
                .anyRequest()
                .authenticated()
                .and()
                .formLogin()
